...
def process_name(food_name):
    name = food_name
    variety = ""
    extra_desc = ""
    return (name, variety, extra_desc)

food_details_mappings = collections.OrderedDict([
    ...
    ("Fat Factor", ((), None)),
    ("Specific Gravity", (("density",), numeric)),
...
nutrition_mappings = collections.OrderedDict([
    ("Public Food Key", (("NUTTAB index",), copy)),
    ("Classification", ((), None)),
    ...
    ("Available carbohydrate, without sugar alcohols", ((), None)),
    ("Available carbohydrate, with sugar alcohols", (("carbohydrate",), numeric)),
    ("Acetic acid", ((), None)),
    ("Citric acid", ((), None)),
    ("Fumaric acid", ((), None)),
    ("Lactic acid", ((), None)),
    ...
    ("Total long chain omega 3 fatty acids", ((), None)),
